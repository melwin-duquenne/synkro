  ...
  <div class="min-h-screen bg-base-200 flex items-center justify-center p-4">
    <div class="w-full max-w-md">
      ...
      <div class="card bg-base-100 shadow-xl">
        <div class="card-body">
          <h2 class="card-title justify-center text-2xl mb-4">Suppression de compte</h2>

          <div v-if="deleted" class="alert alert-success">
            <span>Votre compte a été supprimé. Redirection vers la page de connexion...</span>
          </div>
          ...
          <template v-else>
            ...
            <div v-if="!confirmed" class="space-y-4">
              <div class="alert alert-warning">
                <span>Cette action est irréversible. Toutes vos données seront supprimées définitivement.</span>
              </div>

              <div class="flex gap-2 justify-center">
                <router-link to="/dashboard" class="btn btn-ghost">Annuler</router-link>
                <button class="btn btn-error" @click="confirmed = true">
            ...
            <div v-else class="space-y-4">
              <p class="text-center text-base-content/70">
                Cliquez sur le bouton ci-dessous pour confirmer la suppression définitive de votre compte.
              </p>
