    ...
    <div>
      ...
      <template v-else>
        ...
        <div v-if="(todayEvents?.length ?? 0) > 0" class="mb-6">
          ...
          <div class="space-y-2">
            <div
              ...
              :key="event.id"
              class="flex items-center gap-3 p-3 rounded-lg bg-[#1a3a52] hover:bg-[#2a4a62] transition-colors cursor-pointer"
            ...
            >
              ...
              <div class="flex-1 min-w-0">
                ...
                <div class="badge" :class="getEventBadgeClass(event.eventType)">
                  {{ event.eventType }}
                </div>
              </div>
            </div>
        ...
        <div>
          ...
          <div
            v-if="(upcomingEvents?.length ?? 0) === 0"
          ...
          <div v-else class="space-y-2">
            <div
              ...
              :key="event.id"
              class="flex items-start gap-3 p-3 rounded-lg hover:bg-[#1a3a52] transition-colors cursor-pointer"
