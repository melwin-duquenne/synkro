...
<template>
  <section id="team" class="py-20 lg:py-32 bg-base-200">
    <div class="container mx-auto px-4">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
        <div
          ...
          :key="index"
          class="card bg-base-100 shadow-lg hover:shadow-2xl transition-all duration-300 group"
        >
          <div class="card-body items-center text-center">
            ...
            <div class="flex gap-2">
              <a 
                ...
                class="btn btn-circle btn-ghost btn-sm hover:bg-primary hover:text-primary-content"
                title="LinkedIn"
              >
      ...
      <div class="text-center mt-16">
        <div class="card bg-gradient-to-r from-primary/10 to-secondary/10 max-w-2xl mx-auto">
          <div class="card-body items-center text-center">
            <h3 class="card-title text-2xl mb-2">Rejoignez l'aventure !</h3>
            <p class="text-base-content/70 mb-4">
              Nous sommes toujours à la recherche de talents passionnés pour agrandir notre équipe.
            </p>
