...
const changelogs = ref<ChangelogEntry[]>([
  {
    ...
    changes: [
      ...
      {
        type: "improvement",
        text: "Amélioration des performances du temps réel",
      },
      { type: "improvement", text: "Interface utilisateur rafraîchie" },
      {
        type: "fix",
        text: "Correction du bug de synchronisation du calendrier",
      },
    ],
  },
  {
    ...
    changes: [
      ...
      {
        type: "improvement",
        text: "Performance de l'éditeur améliorée de 300%",
      },
  ...
  },
  {
    ...
    changes: [
      ...
      {
        type: "improvement",
        text: "Amélioration de la gestion des permissions",
      },
...
<template>
  <section
    id="changelog"
    class="py-20 lg:py-32 bg-transparent border-t border-white/6"
  >
    <div class="container mx-auto px-4">
      <!-- Section Header -->
      <div class="text-center mb-16">
        <h2 class="text-4xl md:text-5xl font-bold mb-4 text-[#e7f0fa]">
          Changelog
        </h2>
        <p class="text-xl text-[#8ea4be] max-w-2xl mx-auto">
      ...
      <div class="max-w-4xl mx-auto">
        <div class="space-y-8">
          ...
          >
            ...
            <div
              ...
              class="absolute left-6 top-14 bottom-0 w-0.5 bg-white/10"
            ></div>
            ...
            <div class="flex gap-6">
              ...
              <div class="flex-none relative z-10">
                <div
                  ...
                  :class="
                    entry.isNew
                      ? 'bg-[#408ed6] text-white ring-4 ring-[#408ed6]/20'
                      : 'bg-[#1a3a52] text-[#8ea4be]'
                  "
                >
                  <svg
                    class="w-6 h-6"
              ...
              <div class="flex-1 pb-8">
                <div
                  class="card changelog-card shadow-lg hover:shadow-xl transition-shadow"
                >
                  <div class="card-body">
                    <!-- Header -->
                    <div class="flex items-center gap-3 mb-4">
                      <h3 class="card-title text-2xl text-[#e7f0fa]">
                        v{{ entry.version }}
                      </h3>
                      <div
                        v-if="entry.isNew"
                        class="badge badge-lg gap-1 bg-[#408ed6] border-[#408ed6] text-white"
                      >
                        <svg
                          class="w-4 h-4"
                          fill="none"
                      ...
                      <div class="text-[#8ea4be] text-sm ml-auto">
                        {{ entry.date }}
                      </div>
                    </div>
                    ...
                    <div class="space-y-2">
                      <div
                        ...
                        :key="changeIndex"
                        class="flex items-start gap-3 p-2 rounded-lg hover:bg-[#1a3a52]/45 transition-colors"
                      >
                        <!-- Icon -->
                        ...
                        <div class="flex-1">
                          <div class="flex items-center gap-2 flex-wrap">
                            <span
                              ...
                              :class="getChangeBadgeClass(change.type)"
                            >
                              {{ getChangeLabel(change.type) }}
                            </span>
                            <span class="text-[#dbe6f2]">{{
                              change.text
                            }}</span>
                          </div>
                        </div>
        ...
        <div class="text-center mt-12">
          <button
            class="btn btn-outline gap-2 border-white/15 bg-[#112338]/45 text-[#dbe6f2] hover:border-[#408ed6]/55 hover:bg-[#1a3a52]/70"
          >
            <svg
              class="w-5 h-5"
              fill="none"
...
.changelog-card:hover {
  border-color: rgba(64, 142, 214, 0.35);
}
</style>
